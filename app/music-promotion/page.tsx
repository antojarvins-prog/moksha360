  ...
  return (
    <main className="min-h-screen pt-32 pb-32 bg-[#050505] text-white">
      <div className="container mx-auto max-w-4xl px-4">
        <h1 className="text-4xl md:text-6xl font-bold font-poppins text-transparent bg-clip-text bg-gradient-to-r from-[#4ade80] to-[#13AFF0] mb-8">Music Promotion in Bangalore</h1>
        <p className="text-xl text-gray-300 font-opensans leading-relaxed mb-12">We help artists grow, monetize, and scale globally using state-of-the-art marketing pipelines.</p>
