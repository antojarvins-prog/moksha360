  ...
  return (
    <main className="min-h-screen pt-32 pb-32 bg-[#050505] text-white">
      <div className="container mx-auto max-w-4xl px-4">
        <h1 className="text-4xl md:text-6xl font-bold font-poppins text-transparent bg-clip-text bg-gradient-to-r from-[#4ade80] to-[#13AFF0] mb-8">Music Mentorship</h1>
        <p className="text-xl text-gray-300 font-opensans leading-relaxed mb-12">We help artists grow, monetize, and scale globally through direct 1-on-1 industry mentorship.</p>
        ...
        <section className="mb-16">
           ...
           <ul className="space-y-4">
               <li><Link href="/blog/how-to-build-a-music-brand" className="text-[#13AFF0] hover:underline flex items-center gap-2"><ArrowRight className="w-4 h-4" /> How to Build a Music Brand</Link></li>
               <li><Link href="/blog/how-to-become-a-music-artist-in-bangalore" className="text-[#13AFF0] hover:underline flex items-center gap-2"><ArrowRight className="w-4 h-4" /> How to Become a Music Artist in Bangalore</Link></li>
