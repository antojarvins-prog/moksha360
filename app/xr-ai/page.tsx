  ...
  return (
    <main className="min-h-screen pt-20 pb-32">
      <div className="container mx-auto max-w-4xl px-4">
        <h1 className="text-4xl md:text-6xl font-bold font-poppins text-[#3D7500] mb-6">XR & AI Ecosystems</h1>
        <p className="text-xl text-gray-700 font-opensans leading-relaxed mb-12">We help artists grow, monetize, and scale globally using state-of-the-art XR concerts and AI-automated funnels.</p>
